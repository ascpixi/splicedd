...
export default function SettingsModalContent() {
  const sampleDirState = useCfgSyncedState<string>("sampleDir");
  const placeholdersState = useCfgSyncedState<boolean>("placeholders");
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <Input
                ...
                value={cfg().sampleDir}
                onChange={x => mutateCfgSync(x.target.value, sampleDirState)}
                startContent={
              ...
              <BrowseButton variant="bordered" directory
                onPick={x => mutateCfgSync(x, sampleDirState)}
              >Browse</BrowseButton>
            </div>
            ...
            <div>
              <Switch isSelected={cfg().placeholders} onValueChange={x => mutateCfgSync(x, placeholdersState)}>
                  Enable placeholders
                </Switch>
            </div>
          </div>
